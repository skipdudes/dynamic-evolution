...
from game.core.settings import FONT_UI, IMAGE_OPTIONS_BG, KEY_PAUSE, KEY_INTERACT, WINDOW_WIDTH, WINDOW_HEIGHT, COLOR_TEXT_MAIN
...
class OptionsState(BaseState):
    ...
    def draw(self, screen: pygame.Surface):
        ...
        text = self.font.render("Options Menu - Press ESC to return", True, COLOR_TEXT_MAIN)  # todo: Move to settings
